...
def TEST_LOOP():
    ...
    while True:
        ...
        if cnt == 1:
            robot_status = '@5#14#1#1#1000#876#90#0#0#1#95#1'  # KHONG ket noi voi tram dieu khien trung tam + Che do DK bang tay
        elif cnt == 20:
            robot_status = '@5#14#1#1#1000#876#90#0#0#1#95#2'  # Ket noi tram dieu khien trung tam + Che do DK bang tay
        elif cnt == 40:
            robot_status = '@5#14#1#1#1000#876#90#0#0#1#95#3'  # Ket noi tram dieu khien trung tam + Che do tu dong
        elif cnt == 60:
            robot_status = '@5#14#1#1#1000#876#90#0#0#1#95#4'  # Ket noi tram dieu khien trung tam + Che do tu dong bam vach tu
